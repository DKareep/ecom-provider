...
const Cart = () => {
    const {cart, total_price, shipping_fee, clearCart, removeCartItem, toggleAmount} = useCart()
                    ...
                    {cart?.map(cartItem => {
                        ...
                        return <div key={id} className={"cart-item"}>
                            <div className={"cart-item-basic-details"}>
                                ...
                                <div className={"cart-name-colors"}>
                                    ...
                                    <div>
                                        ...
                                        <div key={color} className={"cart-item-color"}
                            ...
                            <div className={"cart-quantity"}>
                                <ItemsCounter id={id} increment={increaseAmount} decrement={decreaseAmount}
                                              amount={amount}/>
                            </div>
                            ...
                            <div className={"cart-delete-item"}>
                                <FiTrash onClick={() => removeCartItem(id)}/>
                            </div>
